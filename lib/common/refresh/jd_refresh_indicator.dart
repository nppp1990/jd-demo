...
/// [JdRefreshIndicator] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [JdRefreshIndicator.onRefresh].
...
/// Used to configure how [JdRefreshIndicator] can be triggered.
...
///
/// The trigger mode is configured by [JdRefreshIndicator.triggerMode].
///
/// {@tool dartpad}
/// This example shows how [JdRefreshIndicator] can be triggered in different ways.
///
/// ** See code in examples/api/lib/material/refresh_indicator/refresh_indicator.0.dart **
/// {@end-tool}
///
/// {@tool dartpad}
/// This example shows how to trigger [JdRefreshIndicator] in a nested scroll view using
...
///
/// The [JdRefreshIndicator] will appear if its scrollable descendant can be
/// overscrolled, i.e. if the scrollable's content is bigger than its viewport.
/// To ensure that the [JdRefreshIndicator] will always appear, even if the
...
/// ```
///
/// A [JdRefreshIndicator] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.io/design/platform-guidance/android-swipe-to-refresh.html>
///  * [JdRefreshIndicatorState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [JdRefreshIndicator] to show
///    the inner circular progress spinner during refreshes.
///  * [CupertinoSliverRefreshControl], an iOS equivalent of the pull-to-refresh pattern.
///    Must be used as a sliver inside a [CustomScrollView] instead of wrapping
///    around a [ScrollView] because it's a part of the scrollable instead of
///    being overlaid on top of it.
class JdRefreshIndicator extends StatefulWidget {
  ...
  /// Creates an adaptive [JdRefreshIndicator] based on whether the target
  ...
  const JdRefreshIndicator.adaptive({
    super.key,
    required this.child,
    this.displacement = 40.0,
    this.edgeOffset = 0.0,
  ...
  /// Defines how this [JdRefreshIndicator] can be triggered when users overscroll.
  ///
  /// The [JdRefreshIndicator] can be pulled out in two cases,
  ...
  @override
  JdRefreshIndicatorState createState() => JdRefreshIndicatorState();
}

/// Contains the state for a [JdRefreshIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class JdRefreshIndicatorState extends State<JdRefreshIndicator> with TickerProviderStateMixin<JdRefreshIndicator> {
  ...
  @override
  void didUpdateWidget(covariant JdRefreshIndicator oldWidget) {
  ...
  bool _handleScrollNotification(ScrollNotification notification) {
    print('-----_handleScrollNotification----1');
    if (!widget.notificationPredicate(notification)) {
      return false;
    }
    print('-----_handleScrollNotification----2');
  ...
  bool _handleIndicatorNotification(OverscrollIndicatorNotification notification) {
    print('-----_handleIndicatorNotification----1');
    if (notification.depth != 0 || !notification.leading) {
      return false;
    }
    print('-----_handleIndicatorNotification----2');
  ...
  ///
  /// Creating the [JdRefreshIndicator] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [JdRefreshIndicatorState].
  ///
  /// The future returned from this method completes when the
  /// [JdRefreshIndicator.onRefresh] callback's future completes.
  ///
  ...
  Widget build(BuildContext context) {
    ...
    print('---_scaleFactor.value: ${_scaleFactor.value} _positionFactor.value: ${_positionFactor.value}');
    return Stack(
      children: <Widget>[
        child,
