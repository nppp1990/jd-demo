...
typedef WrapHeaderBuilder = Widget Function(double height, RefreshStatus? mode, Widget loadingChild);
...
class TwoLevelHeader extends StatelessWidget {
  ...
  final WrapHeaderBuilder? wrapHeaderBuilder;

  const TwoLevelHeader(
      {Key? key,
      this.wrapHeaderBuilder,
    ...
    return ClassicHeader(
      ...
      outerBuilder: (child) {
        ...
        if (displayAlignment == TwoLevelDisplayAlignment.fromBottom) {
          print('----isTwoLevel:$isTwoLevel');
          if (wrapHeaderBuilder != null && !isTwoLevel) {
            return wrapHeaderBuilder!(
